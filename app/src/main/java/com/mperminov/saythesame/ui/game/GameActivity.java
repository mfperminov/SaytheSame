...
public class GameActivity extends BaseActivity {
  @BindView(R.id.etMessage) EditText edText;
  @BindView(R.id.nickrivalTv) TextView nickRivalTv;
  ...
  @BindView(R.id.timerTv) TextView timerTv;
  @BindView(R.id.matchingWordTv) TextView matchingWordTv;
  @BindView(R.id.button_exit) MaterialButton exitBtn;
  @Inject
  User user;
  @Inject
  ...
  public void showGameResult(String reason) {
    Toast.makeText(this, reason, Toast.LENGTH_SHORT).show();
    exitBtn.setVisibility(View.VISIBLE);
    exitBtn.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View view) {
        MenuActivity.startWithUser(GameActivity.this, user);
      }
    });
  }
}
